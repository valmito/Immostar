...
class __TwigTemplate_6ecb45332068781831861fab86ca829fff00616342cd7b1b76f64d5247d01010 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("Fond.html.twig", "user_security/login.html.twig", 2);
...
<form action=\"";
    ...
    <div class=\"form-group\">
        ...
        // line 12
        echo twig_escape_filter($this->env, (isset($context["lastuser"]) || array_key_exists("lastuser", $context) ? $context["lastuser"] : (function () { throw new RuntimeError('Variable "lastuser" does not exist.', 12, $this->source); })()), "html", null, true);
        echo "\">
    </div>
    <div class=\"form-group\">
    ...
    <button type=\"submit\" class=\"btn btn-primary\"> Se conncter</button>
 </form>
<div>
";
    ...
    {
        return array (  99 => 12,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 2,);
    }

    public function getSourceContext()
    {
        return new Source("{# empty Twig template #}
{% extends \"Fond.html.twig\" %}
...
<form action=\"{{  path('login') }}\" method=\"post\">
    ...
    <div class=\"form-group\">
        <label for=\"username\">Nom utilisateur</label>
        <input type=\"text\" id=\"username\" name=\"_username\" class=\"form-control\" value=\"{{ lastuser }}\">
    </div>
    <div class=\"form-group\">
        <label for=\"password\">Mot de passe</label>
        <input type=\"password\" id=\"password\" name=\"_password\" class=\"form-control\">
...
", "user_security/login.html.twig", "/var/www/html/Immostar/templates/user_security/login.html.twig");
    }
}
