...
// Returns the private 'App\Repository\VisiteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VisiteRepository.php';

return $this->privates['App\\Repository\\VisiteRepository'] = new \App\Repository\VisiteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
